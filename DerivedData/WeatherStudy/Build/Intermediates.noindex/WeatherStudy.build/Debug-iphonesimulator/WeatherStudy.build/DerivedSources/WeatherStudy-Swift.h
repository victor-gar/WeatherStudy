...
#ifndef WEATHERSTUDY_SWIFT_H
#define WEATHERSTUDY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WeatherStudy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12WeatherStudy19AllCitiesController")
@interface AllCitiesController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12WeatherStudy11AppDelegate")
...
SWIFT_CLASS("_TtC12WeatherStudy8CityCell")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12WeatherStudy12GradientView")
...
@property (nonatomic) IBInspectable CGFloat startLocation;
@property (nonatomic) IBInspectable CGFloat endLocation;
...
SWIFT_CLASS("_TtC12WeatherStudy18MyCitiesController")
@interface MyCitiesController : UITableViewController
...
SWIFT_CLASS("_TtC12WeatherStudy13SceneDelegate")
...
SWIFT_CLASS("_TtC12WeatherStudy11WeatherCell")
...
SWIFT_CLASS("_TtC12WeatherStudy21WeatherViewController")
@interface WeatherViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified collectionView;
@property (nonatomic, weak) IBOutlet WeekDayPicker * _Null_unspecified weekPayPicker;
@property (nonatomic, weak) IBOutlet id <UICollectionViewDelegateFlowLayout> _Null_unspecified flowDelegate;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface WeatherViewController (SWIFT_EXTENSION(WeatherStudy)) <UICollectionViewDelegate>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface WeatherViewController (SWIFT_EXTENSION(WeatherStudy)) <UICollectionViewDataSource>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12WeatherStudy13WeekDayPicker")
@interface WeekDayPicker : UIControl
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
